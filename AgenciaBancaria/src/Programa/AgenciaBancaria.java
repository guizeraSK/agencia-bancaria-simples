...
public class AgenciaBancaria {
	...
	public static void operacoes() {
        ...
        int operacao = Integer.parseInt(JOptionPane.showInputDialog("- Selecione um Operação - "
		+ "|  Opção 1 - Criar Conta" + "|  Opção 2 - Depositar" 
		+ "|  Opção 3 - Sacar" + "|  Opção 4 - Transferir" 
		...
		case 6: JOptionPane.showMessageDialog(null, "Obrigado por utilizar nossa agência");System.exit(0);
		default: JOptionPane.showMessageDialog(null, "Opção Inválida");operacoes();break;
		}
	}
